...
<div id="NELE">
  ...
  <div id="Nel">
    ...
    <form autocomplete="off" action="new_project_creador.php" autocomplete="off" method="post" >


            <input id="Sonia" type="search" placeholder="Buscar creador de contenido" name="palabra"
              style="color: white">
    ...
    <li>
        ...
        <ul class="d-menu" data-role="dropdown" >
            ...
            <li id="Men"><a href="http://localhost/project/New_Project/new_project_categoria.php">Categoria</a></li>
              <li class="divider"></li>
                <li id="Men"><a href="http://localhost/project/New_Project/new_project.php">Proyecto
                </a></li>
        </ul>
    </li>
</ul>
